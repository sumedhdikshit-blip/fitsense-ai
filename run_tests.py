...
tests_6 = [(test_chatbot, name) for name in dir(test_chatbot) if name.startswith("test_")]
all_tests = sorted(tests_1 + tests_2 + tests_3 + tests_4 + tests_5 + tests_6, key=lambda x: x[1])
